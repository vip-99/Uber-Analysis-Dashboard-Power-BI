...
## Uber Analysis Dashboard Using Power BI

The objective of this dashboard is to analyze Uber ride data and provide meaningful insights for operational improvements, demand patterns, and location-based trends.
...
## Overview
This project involves a deep dive into Uber's ride-sharing data, showcasing key performance indicators, trip trends, and demand insights across different time frames and locations.
...
## Objective
Analyze Uber ride data using Power BI to identify peak hours, busy pickup locations, customer behavior patterns, and opportunities to improve service delivery.
...
## Data Understanding
The dataset includes trip timestamps, pickup locations, trip counts, and other metrics that help assess user demand and Uber’s operational efficiency.
...
Used Power Query to clean raw data: removed duplicates, formatted timestamps, created time-based columns (hour, day, month), and ensured consistent naming conventions for better analysis.
...
## DAX Calculations
- **Total Trips**: Calculates total number of Uber rides.
- **Avg Trips per Days**: Determines the hour with the most rides.
- **Day with Highest Demand**: Identifies days with maximum trip counts.
- **Trip Trend**: Time-series based ride analysis.
